      ...
      <div className="grid grid-cols-3 items-center gap-x-3">
        <div className="col-span-3 md:col-span-2 text-lg text-slate-50 md:pr-10 text-justify">
          ...
          <p>
            ...
            l&apos;érosion. <br />• Favorise un développement racinaire plus
            régulier et étendu. <br />• Augmente la capacité du sol à filtrer et
            à assimiler les éléments nutritifs.
            <br />
            • Apporte les éléments organiques et les microorganismes essentiels
            à la plante ainsi qu&apos;à la faune et à la flore du sol. <br />•
            Prévient l&apos;acidification du sol ou corrige son acidité grâce à
            un effet tampon. <br />• Contient des phytohormones pour une
            croissance optimale des plantes. <br />• Améliore la structure du
            sol en augmentant les agrégats, facilitant ainsi la pénétration des
            racines et l&apos;exploitation du sol. <br />• Facilite le travail
            du sol. <br />
